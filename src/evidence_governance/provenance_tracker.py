"""
Provenance Tracker - Phase 3L Step 3
Tracks source, platform, ingest date, version, and evidence class (registry).
"""
...
from .config import PROVENANCE_ENABLED, PROVENANCE_STORAGE, get_evidence_class_weight, ensure_directories
...
class ProvenanceTracker:
    ...
    Registry component (separate from scoring engine).
    """
