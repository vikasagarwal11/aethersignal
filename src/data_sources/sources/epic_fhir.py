"""
Epic FHIR Client (Paid Source).
Hospital EHR integration via Epic FHIR API.
"""
...
class EpicFHIRClient(SourceClientBase):
    """
    Client for Epic FHIR - Hospital EHR integration.
    Paid service - requires API key and Epic partnership.
    """
    ...
    def __init__(self, name: str, config: Dict[str, Any]):
        ...
        self.api_key = os.getenv("EPIC_FHIR_KEY", "")
        self.client_id = os.getenv("EPIC_FHIR_CLIENT_ID", "")
        self.client_secret = os.getenv("EPIC_FHIR_CLIENT_SECRET", "")
    
    def fetch(self, query: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Fetch adverse events from Epic FHIR.
        ...
        # Epic FHIR requires OAuth2 token first
        try:
